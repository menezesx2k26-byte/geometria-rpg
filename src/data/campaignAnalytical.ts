...
export const analyticalCampaignQuests: AnalyticalCampaignQuest[] = [
  ...
  q({ number: 14, title: 'Colinearidade por equação', algebraSkills: ['equação linear', 'determinante'], geometrySkills: ['reta por pontos'], teaches: ['coordinate-collinearity'], requires: ['cartesian-coordinates'], commonErrors: ['algebra-linear'] }),
  ...
  q({ number: 28, title: 'Prova métrica por expansão', algebraSkills: ['expansão simbólica', 'cancelamento'], geometrySkills: ['identidade métrica'], teaches: ['coordinate-proof'], requires: ['squared-distance', 'coordinate-collinearity'], difficulty: 4, proofType: 'direct', commonErrors: ['proof-gap', 'algebra-linear'] }),
