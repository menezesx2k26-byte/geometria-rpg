...
export const officialQuest15 = {
  ...
  steps: [
    ...
    { id: 'q15-order', prompt: 'Qual escrita preserva a correspondência C↔C, B↔D, A↔E?', options: [{ id: 'order', label: '△CBA ≅ △CDE' }, { id: 'flip', label: '△ABC ≅ △CDE' }, { id: 'mix', label: '△BCA ≅ △CDE' }], correctId: 'order', success: 'Correspondência ordenada registrada.', error: 'Compare letra por letra: C com C, B com D e A com E.', relation: 'C↔C · B↔D · A↔E' },
